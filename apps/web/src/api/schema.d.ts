...
export interface paths {
    ...
    "/trackers/{slug}/{keyword}": {
         ...
         * @description **Access:** `Public` — No authentication required.
         *
         *     `events` is ordered by `startingAt` descending (most recent contest first); `users` by rank. Each user's `performance` entries carry their own `eventId`, so they can be matched without relying on array position.
         */
        get: {
            parameters: {
                query?: never;
    ...
    "/admin/events/bulk": {
        ...
        put?: never;
        /**
         * Publish, unpublish, or delete a batch of events
         * @description **Access:** `manage_events` — Requires a bearer token for a user granted the `manage_events` permission. The super admin always passes.
         *
         *     `delete` cascades each event's media, attendance, performance rows, and ranklist links, exactly like `DELETE /admin/events/{id}`.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["AdminBulkPublishRequest"];
                };
            };
            responses: {
    ...
    "/admin/events/{id}/media/bulk-remove": {
        ...
        put?: never;
        /**
         * Remove a batch of media items from an event
         * @description **Access:** `manage_events` — Requires a bearer token for a user granted the `manage_events` permission. The super admin always passes.
         *
         *     `ids` are media ids.
         */
    ...
    "/admin/events/{id}/attendance/bulk-remove": {
        ...
        put?: never;
        /**
         * Remove attendance for a batch of users
         * @description **Access:** `manage_attendance` — Requires a bearer token for a user granted the `manage_attendance` permission. The super admin always passes.
         *
         *     `ids` are user ids.
         */
    ...
    "/admin/events/{id}/performance/bulk-remove": {
        ...
        put?: never;
        /**
         * Delete performance rows for a batch of users
         * @description **Access:** `manage_events` — Requires a bearer token for a user granted the `manage_events` permission. The super admin always passes.
         *
    ...
    "/admin/trackers/bulk": {
        ...
        put?: never;
        /**
         * Publish, unpublish, or delete a batch of trackers
         * @description **Access:** `manage_trackers` — Requires a bearer token for a user granted the `manage_trackers` permission. The super admin always passes.
         *
         *     `delete` cascades each tracker's ranklists.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/admin/trackers/{id}/ranklists/bulk": {
        ...
        put?: never;
        /**
         * Publish, unpublish, lock, unlock, or delete a batch of ranklists
         * @description **Access:** `manage_trackers` — Requires a bearer token for a user granted the `manage_trackers` permission. The super admin always passes.
         *
         *     Scoped to the tracker in the path — ids belonging to another tracker are ignored and left out of `affected`.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["AdminRanklistBulkRequest"];
                };
            };
            responses: {
                /** @description Action applied */
    ...
    "/admin/ranklists/{id}/events/bulk": {
        ...
        put?: never;
        /**
         * Detach a batch of events, or set one weight across them
         * @description **Access:** `manage_trackers` — Requires a bearer token for a user granted the `manage_trackers` permission. The super admin always passes.
         *
         *     `ids` are event ids. `set-weight` requires `weight`; scores and ranks recalculate automatically either way.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["AdminRanklistEventBulkRequest"];
                };
            };
            responses: {
                /** @description Action applied */
    ...
    "/admin/ranklists/{id}/users/bulk-remove": {
        ...
        put?: never;
        /**
         * Remove a batch of users from a ranklist
         * @description **Access:** `manage_trackers` — Requires a bearer token for a user granted the `manage_trackers` permission. The super admin always passes.
         *
         *     `ids` are user ids.
         */
    ...
    "/admin/gallery/bulk": {
        ...
        put?: never;
        /**
         * Publish, unpublish, or delete a batch of albums
         * @description **Access:** `manage_gallery` — Requires a bearer token for a user granted the `manage_gallery` permission. The super admin always passes.
         *
         *     `delete` cascades each album's photos.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/admin/blog/bulk": {
        ...
        put?: never;
        /**
         * Publish, unpublish, or delete a batch of posts
         * @description **Access:** `manage_blog` — Requires a bearer token for a user granted the `manage_blog` permission. The super admin always passes.
         *
         *     `publish` stamps `publishedAt` only on posts that have never been published, matching `PATCH /admin/blog/{id}`.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/admin/system/health": {
         ...
         * @description **Access:** `manage_system` — Requires a bearer token for a user granted the `manage_system` permission. The super admin always passes.
         *
         *     Per-job liveness, the last 24 hours of totals, a run strip to chart, and every open fault.
         *
         *     `observed` against `expected` is what detects a cron that has stopped firing — a failure no error, log line, or alert can show, because nothing ran to produce one. Ignore it while `livenessReady` is false.
         */
        get: {
            parameters: {
                query?: never;
    ...
    "/admin/system/runs": {
         ...
         * @description **Access:** `manage_system` — Requires a bearer token for a user granted the `manage_system` permission. The super admin always passes.
         *
         *     Newest first. Runs are kept for 14 days, then pruned on the digest tick.
         */
        get: {
            parameters: {
                query?: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["CronRunList"];
                    };
                };
                /** @description Missing or invalid token */
                401: {
    ...
    "/admin/system/notices/{key}": {
         ...
         * @description **Access:** `manage_system` — Requires a bearer token for a user granted the `manage_system` permission. The super admin always passes.
         *
         *     Drops the fault's cooldown row. Its only purpose is to suppress repeat mail for an hour, so clearing it means both *handled* and *tell me immediately if it recurs* — rather than leaving the admin inside a cooldown started by the problem they just fixed. The runs that raised it stay in the history.
         */
        delete: {
            parameters: {
                query?: never;
...
export interface components {
    schemas: {
        ...
        BulkResult: {
            ok: boolean;
            /** @description Rows the action actually touched. Lower than the number of ids sent when some of them no longer exist or fall outside the parent in the path. */
            affected: number;
        };
        UserList: {
        ...
        AdminBulkPublishRequest: {
            ids: number[];
            /** @enum {string} */
            action: "publish" | "draft" | "delete";
        };
        AdminRanklistBulkRequest: {
            ids: number[];
            /** @enum {string} */
            action: "publish" | "draft" | "lock" | "unlock" | "delete";
        };
        AdminRanklistEventBulkRequest: {
            ids: number[];
            /** @enum {string} */
         ...
         * @enum {string}
         */
        CronRunStatus: "ok" | "degraded" | "crashed";
        CronRun: {
            id: number;
            job: string;
            /** @description Unix epoch seconds (UTC). */
        ...
        SystemJob: {
            job: string;
            /** @description The expression registered in wrangler.jsonc. */
            cron: string;
            /** @description Ticks a full day should contain, derived from `cron`. Null when the expression restricts day-of-month/month/day-of-week, which makes the count depend on the calendar. */
            expected: number | null;
            /** @description Ticks recorded within `livenessWindowSeconds`. */
            observed: number;
            lastRunAt: number | null;
            lastStatus: components["schemas"]["CronRunStatus"] | null;
        ...
        SystemNotice: {
            /** @description Stable fault id, e.g. `codeforces:paging-truncated`. */
            key: string;
            /** @description Unix epoch seconds (UTC). */
            firstSeenAt: number;
            /** @description Unix epoch seconds (UTC). */
            lastSeenAt: number;
            /** @description When the last alert mail went out. */
            lastSentAt: number | null;
            /** @description Occurrences since that mail. */
            occurrences: number;
            lastDetail: string | null;
        };
        SystemHealth: {
            /** @description Server time, so the client can age the timestamps below consistently. */
            now: number;
            /** @description Oldest run still in the ledger. */
            recordingSince: number | null;
            /** @description False while the ledger is younger than one liveness window, when `observed` counts the ledger's age rather than the job's health. */
            livenessReady: boolean;
            livenessWindowSeconds: number;
            /** @description How long runs are kept. */
            retentionDays: number;
            jobs: components["schemas"]["SystemJob"][];
            notices: components["schemas"]["SystemNotice"][];
        };
    };
    responses: never;
    parameters: never;
