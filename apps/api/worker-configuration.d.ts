/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d9a0a14546021a34cb0c2d1419434431)
// Runtime types generated with workerd@1.20260714.1 2026-06-20 nodejs_compat
interface __BaseEnv_Env {
	BUCKET: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	AUTH_RATE_LIMITER: RateLimit;
	CORS_ORIGINS: "https://diuacm-web-stage.sourov-cse.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGINS" | "GOOGLE_CLIENT_ID" | "SUPER_ADMIN_EMAIL" | "ALERT_FROM_EMAIL" | "JWT_SECRET" | "MIGRATION_EXPORT_KEY">> {}
}
