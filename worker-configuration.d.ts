/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 03b6f8a155a7c7f4a05453197fbf2340)
...
interface __BaseEnv_Env {
	...
	JWT_SECRET: string;
	MIGRATION_EXPORT_API_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "JWT_SECRET" | "MIGRATION_EXPORT_API_KEY">> {}
}
